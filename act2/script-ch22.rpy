label sh_ch22:
    label .s1:
        ...
        n "{vspace=30}The long journey here had left the three of us so extremely exhausted that after Akira bid us farewell, we pretty much went to bed immediately without waiting for Lilly's parents to come home."
        ...
        "Hat pressed down, eyes trained on the floor, gaze jumping back and forth as if scanning the ground for landmines, and completely focused on fighting off her anxieties that were trying to get a hold of her flight reflex."
    ...
    label .s2:
        ...
        show hanako cover_worry_sum_close at tworight
        with locationchange
        ...
        show hanako emb_timid_sum_close
        with chchange

        ha "Ummm… She's s-speaking rather quickly, but I think she's s-saying she only knows a few s-standard phrases in Japanese."
        hi "That's a shame. Err… The English say {font=times}‘How are you?’{/font} and {font=times}‘Fine, thank you.’{/font} when they greet each other, don't they?"
        ...
        show hanako cover_distant_sum_close
        show lilly cane_displeased_sum at twoleft
        with charaenter
        ...
        "Maid" "{font=times}Hanako and Hisao.{/font}"

        show hanako cover_bashful_sum_close
        with chchange
        ...
        hi "{font=times}Hello, Allison.{/font}"
        ha "{font=times}H-how d-do you do, Allison?{/font}"
