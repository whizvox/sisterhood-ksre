...
label sh_ch28_journal_en:
    ...
    call screen sh_journal(
        "\n\nLilly's been trying to warm us up to the idea of exploring Inverness on our own. I don't think I'm confident enough yet to try a stilted conversation with some locals in order to ask for directions, but Hisao's English isn't going to get us out of a jam either. I think Lilly's enjoying the idea of us having to practice our English skills the hard way far more than she should. The town of Inverness is really impressive. The older buildings look so different from the ones in Japan. It's really starting to feel like we're on vacation.",
        "\n\nLilly performed a toast. I really envy her bond with Akira. They seem so close. Also, Akira suggests their parents are both workaholics. It explains why they couldn't pick us up from the airport the other day. Interesting tidbit: Lilly learned most of her homemaking skills from their old housekeeper. I wonder if she'd be comfortable with Akira telling us that.\n\nBilliards is great fun, but much more difficult than pool. Fortunately, this was a first time for both of us playing it.\nI told Hisao about what I'd like to do. Hisao has already figured out where he's going to go after graduation. I wonder if there's a university in his hometown of Chiba that I could attend. If we end up studying in different towns, maintaining our relationship is going to be really difficult.",
        [
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p02.jpg"), 0.34, 0.6038)
        ]
    )
    ...
    call screen sh_journal(
        "\n\nFortunately, I felt seriously better around noon. Lilly and I spent nearly an hour preparing picnic food which was fun and a good way to distract myself from the painful sensation in my head. Lilly's mother brought tandem bikes along. Riding them was a bit like playing that motorcycle arcade game with Hisao. It was tricky but fun. At first.\n\nWe ended up visiting some old battlefield, but I didn't quite catch most of what Lilly's mother told us about it. I got unwell during our bike ride, but it was kind of my own fault, so thankfully the picnic didn't end up cancelled over me. We learned that the company of Lilly's family makes medical equipment. And that Lilly's mother was told to come to Scotland just like Lilly was, though unlike her daughter she didn't end up staying at the last moment. I wonder how things would have played out if that had been the case.",
        "\n\nAlso, Lilly's mother used to be a journalist. I got some nasty cramps near the end of the picnic, so Lilly's mother ended up calling the housekeeper to pick us up. I was given A LOT to drink during the picnic and over dinner that evening. I ended up going to bed early that night to recover from today.\n\n\n\n\n\n\n\n\n\n\n\nMusings:\nI really should have remembered last night how terrible I felt that morning after I had wine for the first time, because apparently that first hangover didn't make enough of",
        [
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p03.jpg"), 0.72, 0.4332)
        ]
    )
    ...
    call screen sh_journal(
        "\n\nI was given my own tour of the house this afternoon. It's a really nice place. I asked if I could take some photos of its interior. Lilly and her mother said that was okay, and I could go anywhere I wanted. Maybe I'll do that tomorrow morning. Or some other time when it's still daytime but there aren't many people around.\n\n\n\n\n\n\n\n\n\n\n\nIt'll be interesting to view my photos side by side. If I show pictures of the Japanese rooms to people, they might not believe they were made in the same house as the other ones.",
        "\n\nI also found out today that Lilly's mother has a home trainer that Hisao will be using for his daily practice.\n\nAround four o' clock in the afternoon, we took a trip into the city to walk along the river Ness and visit St. Andrews Cathedral. It was a beautiful church, though we didn't really get a lot of information on its history. I suppose it's still a church first and a tourist attraction second.",
        [
            (Image(f"{sh_path}/gui/journal/dph.png"), 0.34, 0.4503),
            (Text("note to self: take bathroom pic", color="#000"), 0.34, 0.5867),
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p04.jpg"), 0.72, 0.5697)
        ]
    )
    ...
    call screen sh_journal(
        ...
        [
            (Image(f"{sh_path}/gui/journal/d15.png"), 0.34, 0.7403)
        ]
    )

    call screen sh_journal(
        "\n\nWe spent about an hour touring the castle and spent the rest of our time there walking the nature trail nearby and the castle's various beautiful gardens. I think our little walk through the flower garden was one of the most romantic moments of our vacation so far.\n\n\n\n\n\n\n\n\n\n\n\nDespite having brought our own lunch, we actually ended up buying a meal at the snackbar near the bus stop since I gave most of my sandwiches to the ducklings swimming in the nearby pond. I managed to lure a few of them close enough for a",
    ...
    call screen sh_journal(
        "Day 7\n\nNaomi will be pleased. A true Scotsman has been spotted and photographed.\n\n\n\n\n\n\n\n\n\n\n\nNot just that but we also got to see how these traditional Scottish garments are made. We visited the Scottish Kiltmaker Visitor Center as well as a shop specializing in Highland clothes today. In addition to the the exhibition there was also a viewing area where we could see craftsmen at work creating these pieces of clothing. It turns out there is no such thing as THE Scottish kilt; each clan used to have its own pattern as well as an",
        "\n\naccompanying belt with the clan sigil on the buckle and a decorated pouch (it has a name but I forgot what it was) to make up for the fact that kilts have no pockets. While we were at the Highland dress shop, Lilly and I also took the opportunity to try on a few Scottish dresses. I don't think anyone would ever mistake me for a local, but I the dresses looked very natural on Lilly. Hisao snapped some nice pictures of this event.\nThere were a few nice affordable dresses there, but I don't think there'd be a point in me buying one. They stand out so much that I'd never be able to get myself to wear one in public.\n\nMusings:\nI almost filled up my first memory card today and I'm thinking of having a few photos printed out when we visit the shopping center here. Of course, lots of the photos are about the same things shot from a slightly different angle, but I've",
        [
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p09.jpg"), 0.34, 0.2285)
        ]
    )
    ...
    call screen sh_journal(
        "Day 8\n\nToday was another day off. We decided to go shopping in Inverness. There's an indoor market built in Victorian style located near the Ness. It's a really nice looking place filled with all kinds of small owner-operated shops, and the archways and colorful shop facades give the place an atmospheric old-fashioned charm. It was a little more crowded there than I would have liked, but my sun hat did a good job at obscuring the right side of my face.",
        "\n\nAmong the shops we visited were candy stores, a bagpipe store (those things are really expensive!), several tailor and clothing stores and a few gift shops. (I got Naomi a toy Nessie from one of them as a thanks for letting me borrow her camera. She did want to see the Loch Ness monster after all.)\n\n\n\n\n\n\n\n\n\n\n\nWe also bought ingredients for tonight's dinner. Lilly and I will be making fruit cocktail tonight.",
        [
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p10.jpg"), 0.34, 0.5697),
            (Composite((535, 360), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p11.jpg"), 0.72, 0.4332)
        ]
    )
