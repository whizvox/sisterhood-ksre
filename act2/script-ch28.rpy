...
label sh_ch28_journal_en:
    ...
    call screen sh_journal(
        ...
        [
            (Image(f"{sh_path}/gui/journal/d01.png"), 0.4, 0.02),
            (Composite((610, 410), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p01.png"), 0.19, 0.28846153846153846153846153846154)
        ]
    ) with dissolve
    ...
    call screen sh_journal(
        ...
        [
            (Image(f"{sh_path}/gui/journal/d02.png"), 0.29, 0.64)
        ]
    )
