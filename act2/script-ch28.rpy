...
label sh_ch28_journal_en:
    ...
    call screen sh_journal(
        ...
        [
            ...
            (Composite((610, 410), (0, 0), f"{sh_path}/gui/journal/dropshadow.png", (5, 5), f"{sh_path}/gui/journal/p01.png"), 0.72, 0.2968)
        ]
    ) with dissolve
    ...
    call screen sh_journal(
        ...
        [
            ...
            (Text("Body Shame Brigade", color="#000"), 0.4, 0.8085, 0.5, 0, -15.0)
        ]
    )
