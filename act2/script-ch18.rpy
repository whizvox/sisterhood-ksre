label sh_ch18:
    label .s1:
        ...
        aki "Seeing that Sis told me that you two reconciled yesterday, I had a hunch that you were involved in her change of heart somehow. And you pretty much confirmed that just now. So I'm really curious… What exactly happened?"
        ha "Ummm…"
        ...
        ha "What do you mean?"
        aki "When we had our first dinner together in six years, Mom asked Lilly if she was still in contact with Kumi. Kumi was Lilly's best friend at the time Mom and Dad left Japan. Lilly merely answered she wasn't."
        ...
        n "{vspace=60}I take a moment to let Akira's words sink in. Always dodging conflicts is pretty much how, until recently, I often classified Lilly."
        n "{vspace=60}But yesterday I was forced to reconsider that view. I don't know about Lilly's parents, but Lilly herself has proven yesterday that although she's reluctant to move out of her usual diplomatic comfort zone, she's more than capable of speaking candidly about problems if that's the only way to solve them."
        n "{vspace=60}Since Akira doesn't seem to be aware of the specifics of Lilly's phone call with her mother, I feel the need to speak up on her behalf."
        ...
        aki "It all depends on whether she can continue to be straightforward with them or only when her back is against a wall. And if it's the former, maybe I'll just get lucky, and she'll save some of that straight-forwardness for me."
        ...
        aki "Seeing that you did manage to get that confession out of her, I kinda feel that you picked up a ball that I dropped. A ball I really shouldn't have dropped. Since my choice probably influenced hers a lot, it was my responsibility to be the one to coax her into that decision she made yesterday."
        ...
        show akira basic_cheerful_close
        ...
        aki "So I guess a major chewing out is in order here, and I'll be happy to administer it before I leave. But what she did wasn't extremely out of character for her."
        ...
        aki "Yup, that's what friends are for. You know, I kinda feel bad I'm set to leave the country while you're getting more and more out of your shell. I hope you can keep this up, I really do. I guess I'll find out the next time I drop by here. Which I'm sure I will at some point."
        ha "I'll t-try."
        ...
        "She finishes her statement with a bow that contains far more grace than I ever suspected Akira of possessing. I fidget nervously. How am I supposed to react to something like that?"
        ...
        "My eyes widen in shock as I try to digest Akira's seemingly ludicrous statement. Me keeping an eye on Lilly? Not too long ago Lilly was nothing less than a human crutch for me - my only connection to the rest of the student body and, most likely, to the rest of the world as well."
        ...
        aki "Let me tell you something that happened a little while back. Lilly and I were speaking on the phone, and she noted how much you've changed recently. She liked the change in you, but it was also a bit uncomfortable for her."
