label sh_ch34:
    label .s1:
        ...
        "Just as I close the door, I hear the sudden sound of something clattering on a tile floor. Unless Hisao just had a moment of clumsiness in the shower area of our bedroom, the sound I just heard probably came from the bathroom."

        scene bg satou_changingarea

        "I walk up to the door of the bathroom, gently push down the door handle and discover that it's not locked. I peek inside and notice that Lilly's sandals are on one of the shelves and I hear some movements from behind the changing area's inner wall. Lilly's definitely in here."
        "I take off my shoes and socks and put them next to Lilly's sandals on the shelf. I walk into the bathing area, and sure enough, Lilly's kneeling near the small shelves underneath the mirrors."

        scene bg satou_bathroom
        show lilly back_surprise at left
        ...
        li "That was the idea, Hanako. I've only taken a bath once during this trip, and the circumstances were less than ideal back then. Maybe a pleasant soak will help to ease my mind. There should still be plenty of time before dinner."
        ...
        "Lilly gets up, and I allow her to take hold of my sleeve before helping her return to the changing area. She then feels her way over to one of the baskets on the shelves and starts taking off her blouse. I figure that this would probably be a good time to take my leave."
        ...
        "I give Lilly a baffled look as she takes off her skirt. Keep her company?"
        ...
        li "It seems to have been built with group activity in mind. Or family activity."
        ...
        "Still a bit uneasy, I walk back into the changing area and nervously start undressing. While I'm busy doing so, Lilly doesn't say a single word and the only sound audible in the room is the rustling of my clothes."
        "I eventually take off my underwear, pick up a towel and, my legs shaking a bit, walk out of the changing area to face Lilly."

        scene bg satou_bathroom
        show lilly behind_smile_nak

        "I blush a bit at the sight of her as we come face to face. Lilly isn't even bothering to try and cover herself up. She just casually stands there as if she was fully clothed. As my eyes briefly wander over Lilly's body, I feel the painful sting of envy for a moment."
        ...
        "I guide her to the stools while at the same time keeping a bit of additional distance between us so she can't accidentally touch any of my scarred areas, and when we sit down I also make sure that my stool isn't too close to hers."
        "I get a bit of a weird feeling when I pick up one of the shower heads, but then shake the sensation out of my mind and dutifully fill both Lilly's bucket and my own. We quietly proceed to drench ourselves, soap ourselves up and then wash ourselves."
        ...
        scene ev sharedsoak_lilly_smile
        ...
        scene ev sharedsoak_lilly_sadsmile
        ...
        ha "...he... uh... still seemed to have a lot of difficulty speaking, but he talked to us even though it hurt. He... thanked us for helping him and said to l-let him know if there was ever something he could do back. Then he wished us a safe journey."
        li "I see. Did... Akira say anything in particular? When Hisao came back upstairs he said that she invited you for a stroll along the shore."
        ...
        li "I... really want to be understanding of Akira. She's endured a lot of hardships of her own. But... *sigh* what kind of person starts a fight with someone who only just got off life support?"
        ...
        li "I'm also not sure what to think of what Akira said about the way Mother and Father live their lives. Especially Mother. To be honest... I'm not really sure what to think of her to begin with."
        ...
        li "I know it must be difficult for you to believe this, but Mother was a completely different person when she was still living with us in Japan. She was... graceful, gentle, friendly though also just a little bit distant and always very proper and appropriate."
        li "And she was completely devoted to Father and the family. While growing up, Mother was the person I always tried to emulate and resemble."
        ha "R-Really?"
        ...
        "I blush briefly upon hearing Lilly's question. I think if I told Lilly that I let Hisao sleep with me in order to make him come around, she'd probably faint in shock."
        ...
        "While I'm still in the middle of my sentence I suddenly become aware that Lilly has softly put her hand on my shoulder. My right shoulder! I gasp and in a sudden fit of panic, I lunge forward in an attempt to get away."
        ...
        "The splash gets some water in my nose, and I snort and cough a few times before I can regain my composure. I finally calm down enough to realize that I just made an utter fool of myself in front of Lilly and anxiously look over my shoulder at my friend."
        ...
        scene ev sharedsoak_lilly_painfulhistory
        ...
        ha "And there's all the t-time you have. S-So much time - too much time - and nothing to s-spend it on except w-wondering. W-Wondering why t-this happened to y-you and what you d-did to deserve t-this."
        ha "Wondering what y-your life will b-be like afterwards and r-realizing it will probably never b-be the same again."
        ...
        "The fear and panic I felt when I saw the nursing staff enter my room again. Their continuing reassurances how important it was to start these exercises as soon as possible. I suddenly find myself shivering."
        li "Hanako..."
        ...
        ha "The fire happened when I was eight years old. It was night, and I was s-sleeping when it started. I... curled up into a ball... when the f-fire swept over me. My mother... tried to shield me. Th-that's the reason... I lived... and she... d-didn't."
        li "..."
        ha "I was... still on intensive care... f-fighting for my own l-life when the... c-c-cremation took place. M-Maybe it w-was for the best. If... If I h-had been there when they... when they... I d-don't think I w-would have... "
        ...
        "By the time I went to Yamaku, I was... among the oldest ch-children there. For a while, I h-helped with some of the y-younger children, but... I n-never really got to know them either."
        ...
        ha "*sniff* Up to that point, I had been hoping I c-could still maintain... just a little bit of m-my former life, but... it was then that I r-realized that my former life was truly gone for good."

        scene ev sharedsoak_lilly_painfulhistorycry
