label sh_ch19:
    label .s1:
        ...
        nak_ "Allow me to introduce myself: my name is Kensuke Nakamura, and I am a first aid trainer employed at the nearby hospital."
        nak "This is the fourth year I've been giving these courses here. The course planned for this week has been scheduled to take up five days, mostly because I intend to try and give all of you plenty of opportunity for additional practice, which is what we'll be concentrating on in the last two days."
        ...
        "Of course, my reaction draws the attention of the rest, merely contributing to the sense of panic that starts welling up inside me. As my hands start shaking uncontrollably, I am gripped by one all-consuming thought."
        ...
        yu "I found out this morning that I put the keys to the library in the wrong person's pigeon hole, so my replacement for this week couldn't get the library doors open until we tracked down the person who had my keys, and when we found him he told us he just dropped the keys back in my own pigeon hole and..."
        ...
        show nakamura normal at tworight
        ...
        hide yuuko
        show nakamura normal at center
        ...
        "I breathe a quiet sigh of relief and quickly nod my head. The art teacher gives an indifferent shrug and then walks over to Yuuko's initial partner. Nakamura takes the practice dummies out of their bags and carries three of them to a different corner of the room and then puts one in the center."
        ...
        "I give her a small smile. Truth be told, I'm often at a loss on how to handle Yuuko's erratic mood swings, but currently there's no other person in the room I'd rather be paired up with. It feels comforting to know I'll be working with someone who won't judge me for my skittish behavior."
        "I suppose it feels good for her as well to pair up with someone who won't judge her. As we sit down on the floor next to the dummy, Nakamura walks to the center of the classroom."

        show nakamura normal
        hide yuuko

        nak "Before we start the first part, I'd like to hold a short introduction. What we teach here won't make you a perfect substitute for a doctor or a trained nurse. The goal of first aid in case of an emergency is to stabilize the victim until professional help arrives."
        ...
        nak "So, for short. In case of an accident or if anybody collapses in front of you, there are three simple steps. One, always call an ambulance. Two, check for vital signs, and do a quick checkup to see what can be done to stabilize a person's condition."
        ...
        show nakamura normal at twoleft
        ...
        nak "You were doing well, Ikezawa. Though you were probably a little bit too gentle. I don't think those were compressions of 5 centimeters. Try pressing deeper the next time. Remember: if a victim complains about his ribs hurting afterwards, it means you've done something right."
        ha "I-I'll try."
        ...
        "As I get up, I rub my sore arms. Those CPR practice sessions really made me wish I was more atlethic. Still, aside from the rough start this morning, I think I learned a lot of valuable things. And Yuuko proved to be a pleasant, although panic-prone, partner."
        ...
        "The girl, whose name is Jun Yamazaki, is the club member whom I was initially drafted to replace for a little while as assistent editor."
        ...
        n "{vspace=60}She's a bit of a whiz kid whose knack for computers far exceeds my own, and she joined the newspaper club for the specific purpose of getting to do the editing jobs. Last week we ended up working together a few times to put the latest issue of the school newspaper together."
        n "{vspace=60}I'm not completely comfortable around her yet, but due to her skinny build and her usually quiet demeanor, her presence is not exactly threatening either. When I was first invited into the club, I learned that Jun suffers from osteoporosis and is very prone to breaking bones as a result of minor falls that other people would simply shrug off."
