...
n "I'm worthless."
n "As I sit on the ground, knees drawn up to my chin and my hat almost pushed over my eyes, that thought keeps returning to me over and over."
n "I'm worthless."
n "The period after Hisao made me his girlfriend has been the happiest time of my life. The person I was in love with loved me as well, and we started a relationship. We were both going through a difficult time and made a pledge to support each other in each other's times of need."

nvl clear

n "I'm worthless."
n "Due to my success in winning Hisao's heart, I started reconsidering my previously held belief that I was a useless person to others. I started believing I was only as useless to people as I allowed myself to be. I started making active efforts to become a better girlfriend to Hisao, a better best friend to Lilly and a better club member to Naomi and the others."
n "I'm worthless."
n "I started enjoying the small things in life. The girl-talk with Lilly, the brainstorming sessions over headlines and captions at the club, the tranquil days in Hokkaido and the occasional lovey-dovey exchanges with Hisao. Each of them brought a smile to my face when I recalled them before falling asleep in the evening."
n "I'm worthless."
n "My body, despite being scarred and disfigured, was still capable of making Hisao feel good. And despite part of my body being numb, he was able to return the favor as well."
n "I'm worthless."

nvl clear

n "I stopped trying to survive from day to day and started considering my options for the future. If only things could have stayed like this for a little while longer."
n "I'm worthless."
n "The person I considered my best friend announced she might be leaving the country and it seemed my efforts to sway her had the opposite effect. Then, last Monday, everything came crashing down. Once more, I became an emotional mess hiding away from the world."
n "I'm worthless."
...
show hisao neutral_vest_rn
with charachangealways

hi "A little something I picked up at the gift shop near the hospital's cafeteria."

play music music_innocence fadein 0.5
# TODO show bouquet of flowers VFX
...
show hisao smile_vest_close_rn
with charachangealways
...
show hisao listen_vest_close_rn
with charachangealways

"He takes a deep breath."

show hisao neutral_vest_close_rn
with charachangealways
...
show hisao shocked_vest_close_rn
with chchange
...
show hisao speak_vest_close_rn
with chchange
...
# TODO show hisao and hanako hugging CG
...
ha "I… was a-afraid to face them after n-neglecting you the entire w-week and I *sigh* got scared and ran off."
...
show hisao frown_vest_close_rn
with chchange
