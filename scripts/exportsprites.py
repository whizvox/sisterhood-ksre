...
takawa = [
    ...
    ("Sprites/Takawa/edits/takawa_weaksmile", "weaksmile"),
]
...
karla = [
    # suit
    ("Sprites/Karla/SUIT/1 KARLA SUIT SMILE", "basic_smile"),
    ("Sprites/Karla/SUIT/2 KARLA SUIT SMILE CLOSED", "basic_smileclosed"),
    ("Sprites/Karla/SUIT/3 KARLA SUIT SHEEPISH", "basic_sheepish"),
    ("Sprites/Karla/SUIT/4 KARLA SUIT SHEEPISH CLOSED", "basic_sheepishclosed"),
    ("Sprites/Karla/SUIT/5 KARLA SUIT CHEERFUL", "basic_cheerful"),
    ("Sprites/Karla/SUIT/6 KARLA SUIT SMUG", "basic_smug"),
    ("Sprites/Karla/SUIT/7 KARLA SUIT TROUBLED", "basic_troubled"),
    ("Sprites/Karla/SUIT/8 KARLA SUIT DISPLEASED", "basic_displeased"),
    ("Sprites/Karla/SUIT/9 KARLA SUIT DISPLEASED CROSSED", "cross_displeased"),
    ("Sprites/Karla/SUIT/10 KARLA SUIT ANGRY", "basic_angry"),
    ("Sprites/Karla/SUIT/11 KARLA SUIT ANGRY CROSSED", "cross_angry"),
    ("Sprites/Karla/SUIT/12 KARLA SUIT LAUGH FIX", "basic_laugh"),
    ("Sprites/Karla/SUIT/13 KARLA SUIT CONFUSED", "basic_confused"),
    ("Sprites/Karla/SUIT/14 KARLA SUIT SERIOUS", "basic_serious"),
    ("Sprites/Karla/SUIT/15 KARLA SUIT SPEAK", "basic_speak"),
    ("Sprites/Karla/SUIT/16 KARLA SUIT DISTANT", "basic_distant"),
    ("Sprites/Karla/SUIT/17 KARLA SUIT PONDER", "basic_ponder"),
    ("Sprites/Karla/SUIT/18 KARLA SUIT PONDER CROSSED", "cross_ponder"),
    ("Sprites/Karla/SUIT/19 KARLA SUIT WORRIED", "basic_worried"),
    # casual
    ("Sprites/Karla/CASUAL/edit/KARLA CASUAL CONFIDENT", "basic_confident_cas"),
    ("Sprites/Karla/CASUAL/1 KARLA CASUAL SMILE", "basic_smile_cas"),
    ("Sprites/Karla/CASUAL/2 KARLA CASUAL SMILE CLOSED", "basic_smileclosed_cas"),
    ("Sprites/Karla/CASUAL/3 KARLA CASUAL SHEEPISH", "basic_sheepish_cas"),
    ("Sprites/Karla/CASUAL/4 KARLA CASUAL SHEEPISH CLOSED", "basic_sheepishclosed_cas"),
    ("Sprites/Karla/CASUAL/5 KARLA CASUAL CHEERFUL", "basic_cheerful_cas"),
    ("Sprites/Karla/CASUAL/6 KARLA CASUAL SMUG", "basic_smug_cas"),
    ("Sprites/Karla/CASUAL/7 KARLA CASUAL TROUBLED", "basic_troubled_cas"),
    ("Sprites/Karla/CASUAL/8 KARLA CASUAL DISPLEASED", "basic_displeased_cas"),
    ("Sprites/Karla/CASUAL/9 KARLA CASUAL DISPLEASED CROSSED", "cross_displeased_cas"),
    ("Sprites/Karla/CASUAL/10 KARLA CASUAL ANGRY", "basic_angry_cas"),
    ...
    ("Sprites/Karla/CASUAL/12 KARLA CASUAL LAUGH", "basic_laugh_cas"),
    ("Sprites/Karla/CASUAL/13 KARLA CASUAL CONFUSED", "basic_confused_cas"),
    ("Sprites/Karla/CASUAL/14 KARLA CASUAL SERIOUS", "basic_serious_cas"),
    ("Sprites/Karla/CASUAL/15 KARLA CASUAL SPEAK", "basic_speak_cas"),
    ("Sprites/Karla/CASUAL/16 KARLA CASUAL DISTANT", "basic_distant_cas"),
    ("Sprites/Karla/CASUAL/17 KARLA CASUAL PONDER", "basic_ponder_cas"),
    ("Sprites/Karla/CASUAL/18 KARLA CASUAL PONDER CROSSED", "cross_ponder_cas"),
    ("Sprites/Karla/CASUAL/19 KARLA CASUAL WORRIED", "basic_worried_cas"),
