...
IMAGES: list[tuple[str, str, list[ImageTransformation]]] = [
    ...
    ("@Event Art/Ch 24 Cello and Wine/1.1_fix.png",     "event/celloandwine/celloandwine_cello_play.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/1.2_fix.png",     "event/celloandwine/celloandwine_cello_lookup.jpg"),
    ...
    ("@Event Art/Ch 24 Cello and Wine/edit/3.1.png",    "event/celloandwine/celloandwine_lap_tease.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/edit/3.2.png",    "event/celloandwine/celloandwine_lap_rest.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/edit/3.3.png",    "event/celloandwine/celloandwine_lap_cover.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/edit/3.4.png",    "event/celloandwine/celloandwine_lap_feel.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/3.5.png",         "event/celloandwine/celloandwine_lap_clap.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/3.6.png",         "event/celloandwine/celloandwine_lap_victory.jpg"),
    ("@Event Art/Ch 24 Cello and Wine/edit/3.7.png",    "event/celloandwine/celloandwine_lap_kiss.jpg"),
    # chapter 24+25 - Tipsy Fun
    ("@Event Art/Tipsy Fun/01_scene.png",                   "event/tipsyfun/tipsyfun_stand_close.jpg"),
    ("@Event Art/Tipsy Fun/1.2_scene.png",                  "event/tipsyfun/tipsyfun_stand_naked.jpg"),
    ("@Event Art/Tipsy Fun/2_scene.png",                    "event/tipsyfun/tipsyfun_doggystyle.jpg"),
    ("@Event Art/Tipsy Fun/2_closedeyesscene_edit2.png",    "event/tipsyfun/tipsyfun_doggystyle_closed.jpg"),
    ...
    # chapter 29+33 - Shared Soak
    ("@Event Art/Shared Soak/edits/hisao_relax.png", "event/sharedsoak/sharedsoak_hisao_relax.jpg", [RESIZE_1080P]),
    ("@Event Art/Shared Soak/edits/hisao_talk.png", "event/sharedsoak/sharedsoak_hisao_talk.jpg", [RESIZE_1080P]),
    ("@Event Art/Shared Soak/cutouts/hisao_hisao_talk.png", "event/sharedsoak/sharedsoak_hisao_hisaotalk.png", [RESIZE_1080P]),
    ...
    # chapter 34
    ("@Event Art/Hanako History/Hanako_backstory_01.png",       "event/hanakohistory/hanakohistory_bed.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_02.png",       "event/hanakohistory/hanakohistory_bed_pain.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_03_A.png",     "event/hanakohistory/hanakohistory_fire.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_03_B.png",     "event/hanakohistory/hanakohistory_fire_alone.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_04.png",       "event/hanakohistory/hanakohistory_urn.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_05.png",       "event/hanakohistory/hanakohistory_read.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_06.png",       "event/hanakohistory/hanakohistory_read_leave.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_06_B.png",     "event/hanakohistory/hanakohistory_read_alone.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_07.png",       "event/hanakohistory/hanakohistory_play.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_08.png",       "event/hanakohistory/hanakohistory_play_tease.jpg"),
    ("@Event Art/Hanako History/Hanako_backstory_09.png",       "event/hanakohistory/hanakohistory_bully.jpg"),
...
PHOTOGRAPHS: list[tuple[str, str, list[ImageTransformation]]] = [
    ...
    ("@Journal/photos/p04.png", "gui/journal/p04.jpg", [resize(525, 350)]),
    ...
    ("@Journal/photos/p13.png", "gui/journal/p13.jpg", [crop(0, 8, 1024, 691), resize(525, 350)]),
