...
IMAGES: list[tuple[str, str, list[ImageTransformation]]] = [
    ...
    ("reference/Event Art/Bedridden/overlay/akira_distant.png", "event/bedridden/bedridden_akira_distant_overlay.png", [RESIZE_1080P]),
    ("reference/Event Art/Bedridden/overlay/akira_frown.png", "event/bedridden/bedridden_akira_frown_overlay.png", [RESIZE_1080P]),
    ...
    ("reference/Event Art/Bedridden/overlay/hiroyuki_shout.png", "event/bedridden/bedridden_hiroyuki_shout_overlay.png", [RESIZE_1080P]),
    # chapter 33
