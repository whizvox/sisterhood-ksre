...
li "I can assure you I will have all paperwork done before the deadline of tomorrow. That should be all that matters. Or are you now concerned with other things besides cold, hard results all of a sudden?"
"And here I am taking the bait again. I'm not sure why I can't take Shizune's provocations with a grain of salt like Hisao seems able to do without any significant effort."
"Perhaps the fact that we're family makes it more difficult to back down."
...
li "People can still surprise each other on occasion, Shizune. I must admit I was somewhat surprised by the efforts you made to help Hisao and Hanako through last week. Your actions were most certainly appreciated."
...
"There's a moment of silence in the room, beyond the sound of a shocked gasp. I allow myself to send a sweet, but triumphant smile in Shizune's general direction."
...
"Of course, my classmates' action was a surprise to me as well rather than anything planned, but I must admit getting a small victory over Shizune feels surprisingly good to me. Maybe we really are more alike than either of us cares to admit."
...
li "I understand. I accept the fact that there are things that neither of us will budge on. I may not think highly of your methods as a student council president, but I think I can still appreciate you as a cousin, Shizune."
...
ha "I-I'm s-sorry too f-for saying those horrible things to you. I… felt really bad about it afterwards."
...
ha "It's… okay. You were probably w-worried about me."
...
ha "Lilly… I want to see you off without hard feelings. So if you're… not angry with me then I won't be a-angry with you."
...
"Is she sincere in her answers? She said she wants to see me off without hard feelings. But hard feelings on her part or mine? Is she simply saying what she thinks I want to hear?"
...
li "I believe there was also a reason behind your other words. I… I really want to know what it is."
...
li "Please, Hanako… I promise you I will not think badly of you, no matter what you say. But please don't deny me the chance to take responsibility for my actions."
...
ha "But sometimes, I w-worried… whether we were really f-friends or not."
li "Why?"
...
ha "It was like… I was just someone you needed to t-take c-care of. Like you w-were a m-mother taking care of a n-needy child."
...
li "It is… my way of showing affection. I never… realized I could hurt others that way."
...
ha "I realized… I was only useless if I allowed myself to be. I realized… I could become stronger and change if I w-worked hard at it. I could become a better girlfriend for Hisao. And I could become a better friend to you."
ha "I w-wanted to become r-real friends with you. B-but then, you announced you were maybe leaving the c-country."
...
ha "When I started s-spending more time with you, I started thinking. M-maybe if I could b-become a better friend to you… If I could s-show you how m-much our friendship still h-had to offer… maybe you would be more tempted to stay."
"Except I ultimately ended up deciding to leave Japan despite Hanako's best efforts…"
"No, not despite…"

show hanako emb_sad
with chchange

ha "Lilly, that n-night before you told us you were going to Scotland, I t-told you about my p-plans for the future and m-more than ever I felt like we were on equal footing… but you seemed s-sad when you noted how much I had changed."
...
"But I know that if Hanako is given the chance to get up and run out of the room now, I'll never be able to catch her, and she'll spend the rest of the next two days avoiding me. I have to keep control of the conversation if I don't want this to end badly."
...
li "That was probably very naïve. I think all four of us sensed it while we were staying at our parents' mansion. Things were… pleasant, but distant. We truly have grown apart as a family."
...
ha "But… when you told us about the s-summons, you were still doubting. You didn't think it would w-work?"

li "I'm not sure. Maybe. Maybe not. I don't think Akira will be visiting there very often."
li "As for me… I've found that I… have a lot of trouble letting go of the life I have here. Despite Mother and Father not being present, I've been… happy here."

show hanako emb_sad
with chchange

ha "Lilly… I think that what you're s-saying is that d-deep down you don't really want to go."
li "It's very strange. I… do want us to be a family again. It's been my biggest wish for years."
...
ha "That's… not very f-fair."
li "That's… also how I felt, when my parents took me aside and asked why I was so hesitant."
li "But I… couldn't tell them. I was afraid to… well… come across as a bad daughter."
...
li "That time we've spent doing all sorts of fun things together was the highlight of our friendship to me. I will never forget them or you for as long as I live. So please don't think I think of you as…"
...
li "That's… a bit of a worst-case scenario. And besides… I've made a promise already."
...
li "How can I… tell my parents that I reject their reconciliation offer? What kind of daughter would do that?"

show hanako emb_timid_close
with chchange

ha "I… think… you c-can still reconcile… in other w-ways. And m-maybe someday you'll be close enough to them that moving to Scotland will m-make you happy."
ha "Now is just… not the time."
li "Hanako, I've never heard you this persistent before."

show hanako basic_worry_close
with chchange

ha "I think… if I l-let you go like this, I w-won't be able to live with myself."
ha "Also, I r-really want you to s-stay here with us. It w-would make me… really happy."
"Judging by the determination in her voice, she really isn't going to give up. To be honest, if the roles were reversed, I'd probably be doing the same thing."
...
"Oh no!"
li "Mother, a-about that… I… I have to tell you something."
kam "What is it dear?"
li "I… I'd like to stay here… in Japan."
kam "Oh dear, is your friend still in the hospital?"
li "N-no, that's not it. He's back already. He's doing pretty well now."
li "What I meant to say is… I…"
li "I've changed my mind… about… moving."
...
li "I… didn't really know a lot of things about you anymore. We've interacted so little over the last six years. We've never visited, and we barely spoke."
li "We didn't grow apart because of the distance, Mother. We grew apart because we stopped communicating with each other."
kam "That's… probably true. I'm sorry…"
li "I want to make a new start as well, Mother. But I don't feel I need to give up what I have here to do that."
li "We could… call each other two or three times a week. A few minutes is all it will take to let each other know what's been going on in our lives."
...
kam "You… have really thought this through, haven't you?"
...
li "See each other?"
kam "I… I'm sorry. I didn't mean to…"
...
# TODO show Lilly hugging Hanako CG

"I embrace Hanako and break down in tears as everything comes flooding out of me."
"The anxiety of meeting my family again…"
"…the terrible pressure of being forced to make a life-changing decision…"
"…the concern after Hisao's accident…"
...
aki "Well, I'll be… Were you planning this all along when you offered to come over again?"
...
ha "Ummm… I actually liked to have a bit more time alone with you. He didn't mind."
...
ha "Lilly?"
li "Yes?"
ha "The friend you spoke to your mother about on the phone…"
ha "Was that… m-me?"
...
ha "I… I was feeling the exact same thing."
...
ha "I'm… looking forward to getting to know you better, Lilly. I'm… really honored I learned about some of your past today."
...
ha "My past… is not pretty, Lilly."

show hanako emb_smile_close
with chchange

ha "But I think… in time… I can share it with you."
li "I will wait for that day, Hanako."

stop music fadeout 3.0

ha "In the meantime, there's something I think I'm… comfortable sharing with you. Something I'd like you to experience."
