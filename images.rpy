init 1 python:
    ...
    sh_sprites("hanako", ["blushtimid", "downsad", "downsmile", "downtimid", "sad", "smile", "timid"], poses=["emb"], outfits=["sum"])
    ...
    sh_sprites("lilly", ["cheerful", "displeased", "giggle", "oops", "planned", "pout", "reminisce", "satisfied", "smile", "smileclosed", "weaksmile"], poses=["basic", "cane"], outfits=["sum"])
