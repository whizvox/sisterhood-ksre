...
"A momentary silence."
"Silences around Hanako are sometimes uncomfortable, but right now they feel alright due how relaxing our surroundings are."
hi "Hanako?"
ha "Yes?"
...
n "Still, her scolding was only a minor inconvenience."
...
n "I later questioned her about it, but she replied by saying she wasn't forcing us to sleep in the same bed, and the sight of Hanako in her nightgown wasn't anything new to me."
n "When I realized that in order to continue the discussion I'd have to get into how far along Hanako and I were in that area, I decided not to paint myself into corner and dropped the subject while I was still ahead."
n "I was, of course, a gentleman, so Hanako was given the double bed while I spent the first night in the smaller one. All in all, it was still a pretty comfortable place to sleep."
...
n "Is having that kind of intimacy something Hanako will ever be doing for her own enjoyment to begin with?"
...
n "I wonder if there's an opportunity to talk to her about it without her freezing up in embarrassment. I've learned over the last few weeks that making assumptions about Hanako isn't always the smartest thing to do."
